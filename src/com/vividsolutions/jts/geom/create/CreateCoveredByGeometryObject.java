 ...
 * @author jsaveta
 */
public class CreateCoveredByGeometryObject extends GeometryType {
    ...
    public CreateCoveredByGeometryObject(Geometry givenGeometry, GeometryType.GeometryTypes geometry) {
        this.chunk = 2;
