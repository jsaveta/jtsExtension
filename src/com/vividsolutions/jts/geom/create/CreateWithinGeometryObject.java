 ...
 * @author jsaveta
 */
public class CreateWithinGeometryObject extends GeometryType {
    ...
    public CreateWithinGeometryObject(Geometry givenGeometry, GeometryType.GeometryTypes geometry) {
        this.chunk = 2;
