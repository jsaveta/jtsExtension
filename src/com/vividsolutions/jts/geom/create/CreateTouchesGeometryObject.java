            ...
            case "LineString":
                ...
                switch (this.returnedGeometry.getSimpleName()) {
                    ...
                    case "MultiPoint":
                        break;
                    case "LineString":
                        //choose a random point from the given linestring (boundary or interior)
                        //and generate a new linestring that has as common point only the selected one
                        //let the size of the generated linestring be equal with the given
                        //how can we generate linestrings either with long/lat or simple points? 
