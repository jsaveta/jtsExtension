 ...
 * matrix. DE-9IM matrices (such as "212FF1FF2") specify the topological
 ...
 * see the <i><A
 *  HREF="http://www.opengis.org/techno/specs.htm">OGC 99-049 OpenGIS Simple
 * Features Specification for SQL</A></i>, as well as
 * <i>OGC 06-103r4 OpenGIS Implementation Standard for Geographic information -
...
public class IntersectionMatrix implements Cloneable {
     ...
     *
     * @param actualDimensionValue a number that can be stored in the
     ...
     * representation of an <code>IntersectionMatrix</code>. Possible values are
     * <code>{T, F, * , 0, 1, 2}</code>.
    ...
    /**
     * Tests if each of the actual dimension symbols in a matrix string
     * satisfies the corresponding required dimension symbol in a pattern
     * string.
     *
     ...
     *
     * @param dimensionSymbols nine dimension symbols to which to set this
     ...
     * indicating the interior, boundary or exterior of the second
     * <code>Geometry</code>
     * @param minimumDimensionValue the dimension value with which to compare
     * the element. The order of dimension values from least to greatest is
     ...
     * compare the elements of this <code>IntersectionMatrix</code>. The order
     ...
     *
     * @param dimensionValue the dimension value to which to set this
    ...
    /**
     * Returns the value of one of this matrix entries. The value of the
     * provided index is one of the values from the {@link Location} class. The
     * value returned is a constant from the {@link Dimension} class.
     *
     * @param row the row of this <code>IntersectionMatrix</code>, indicating
     * the interior, boundary or exterior of the first <code>Geometry</code>
     * @param column the column of this <code>IntersectionMatrix</code>,
     ...
     * FT*******, F**T***** or F***T****.
     *
     * @param dimensionOfGeometryA the dimension of the first
     * <code>Geometry</code>
     * @param dimensionOfGeometryB the dimension of the second
     * <code>Geometry</code>
     * @return                       <code>true</code> if the two <code>Geometry</code> s related by
     * this <code>IntersectionMatrix</code> touch; Returns false if both
     * <code>Geometry</code>s are points.
     */
    public boolean isTouches(int dimensionOfGeometryA, int dimensionOfGeometryB) {
//      System.out.println("is touches");
...
//        System.out.println(matrix[Location.INTERIOR][Location.INTERIOR] == Dimension.FALSE);
//        System.out.println(isTrue(matrix[Location.INTERIOR][Location.BOUNDARY]));
//        System.out.println(isTrue(matrix[Location.BOUNDARY][Location.INTERIOR]));
//        System.out.println(isTrue(matrix[Location.BOUNDARY][Location.BOUNDARY]));
     ...
     * <code>Geometry</code>
     * @return                       <code>true</code> if the two <code>Geometry</code>s related by
     * this <code>IntersectionMatrix</code> cross.
     */
     ...
     *
     * @return    <code>true</code> if the first <code>Geometry</code> is covered
     * by the second
     */
     ...
     * <code>IntersectionMatrix</code> matches the pattern <tt>T*F**FFF*</tt>.
     * <p>
     * <b>Note:</b> This pattern differs from the one stated in
     * <i>Simple feature access - Part 1: Common architecture</i>. That document
     * states the pattern as <tt>TFFFTFFFT</tt>. This would specify that two
     * identical <tt>POINT</tt>s are not equal, which is not desirable
     * behaviour. The pattern used here has been corrected to compute equality
     * in this situation.
     *
     * @param dimensionOfGeometryA the dimension of the first
     * <code>Geometry</code>
     ...
     * <code>Geometry</code>
     * @return                       <code>true</code> if the two <code>Geometry</code>s related by
     * this <code>IntersectionMatrix</code> are equal; the
     ...
     * <code>Geometry</code>
     * @return                       <code>true</code> if the two <code>Geometry</code>s related by
     * this <code>IntersectionMatrix</code> overlap. For this function to return
     * <code>true</code>, the <code>Geometry</code>s must be two points, two
     ...
     * @return                           <code>true</code> if this <code>IntersectionMatrix</code> matches
     * the required dimension symbols
     */
