...
public class LineStringGenerator extends GeometryGenerator {
    ...
    /**
     * Create the points in an approximation of an open circle (one edge will
     * not be included).
     *
     ...
     * random valid linestring decreases. Please take not of this when selecting
     * the generation style, and the number of points.
     *
...
//        double step = 0.001;
    ...
    private static void fillArc(double x, double dx, double y, double dy, Coordinate[] coords, GeometryFactory gf) {
        ...
        //It was like that : double theta = 360 / coords.length;
        //I added (double)
        double theta = 360 / (double) coords.length;
